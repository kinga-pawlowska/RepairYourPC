...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        login = (EditText) findViewById(R.id.etMainLogin);
        password = (EditText) findViewById(R.id.etMainPassword);
        login.setText("");
        password.setText("");
        Button loginButton = (Button) findViewById(R.id.btnMainLogin);
        Button registerButton = (Button) findViewById(R.id.btnMainRegister);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (enteredLogin.equals("") || enteredPassword.equals("")) {
                    Toast.makeText(MainActivity.this, "Login or password must be filled", Toast.LENGTH_LONG).show();
                    return;
                }
                if (enteredLogin.length() <= 1 || enteredPassword.length() <= 1) {
                    Toast.makeText(MainActivity.this, "Login or password length must be greater than one", Toast.LENGTH_LONG).show();
                    return;
                }
                // request authentication with remote server4
                AsyncDataClass asyncRequestObject = new AsyncDataClass();
                asyncRequestObject.execute(serverUrl, enteredLogin, enteredPassword);
            }
        });
